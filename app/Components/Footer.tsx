    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 md:py-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 sm:gap-8 md:gap-10 lg:gap-12 mb-6 sm:mb-8 md:mb-10">
          ...
          {/* Social Links */}
          <div className="flex gap-3 sm:gap-4 w-full md:w-auto justify-center md:justify-end">
            <Link
              href="#"
              aria-label="Facebook"
              className="w-9 h-9 sm:w-10 sm:h-10 bg-white/15 hover:bg-emerald-400/80 text-slate-100 hover:text-white rounded-full flex items-center justify-center transition-colors"
            >
              <svg
